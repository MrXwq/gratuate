...
router.post('/commodity', async (req, res) => {
    const model = await Commodity.create(req.body)
    res.send(model)
})
router.put('/commodity/:id', async (req, res) => {
    const model = await Commodity.findByIdAndUpdate(req.params.id, req.body)
    res.send(model)
})
router.delete('/commodity/:id', async (req, res) => {
    await Commodity.findByIdAndDelete(req.params.id, req.body)
    res.send({
        success: true
    })
})
